  ...
  return (
    <div className="min-h-screen flex bg-[#050505] text-slate-200 selection:bg-primary/30">
      ...
      <div className="hidden lg:flex flex-1 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="absolute top-[-20%] left-[-20%] w-96 h-96 bg-primary/20 rounded-full mix-blend-screen filter blur-[100px] animate-blob" />
        ...
        <div className="relative z-10 max-w-md">
          <h2 className="text-4xl font-bold text-white mb-6 leading-tight">Automate your revenue engine.</h2>
          <p className="text-lg text-slate-400">Join top-performing teams scaling outbound without sacrificing personalization.</p>
        </div>
      </div>

      {/* Right Panel - Login Form */}
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-12 lg:px-24 xl:px-32 relative border-l border-white/5 bg-[#0a0a0f] py-12 lg:py-0">
        <motion.div
        ...
        >
          ...
          <p className="text-center text-sm text-slate-400 mt-8">
            Don&apos;t have an account? <Link href="/signup" className="text-primary font-medium hover:underline">Start free trial</Link>
          </p>
        </motion.div>
      </div>
    </div>
